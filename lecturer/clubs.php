...
<br>    
    ...
    <input type="tel" name="tel" id="tel" placeholder="Your Mobile Number.." required="required">
<br>    
...
<script type="text/javascript">
    ...
    function reply_click(clicked_id)
    {
        if(clicked_id == "demo")
        {
            document.getElementById('fname').value = 'Michael';
			document.getElementById('lname').value = 'James';
			...
			document.getElementById('ID').value = 'IT20023192';
