...
while ($row = mysqli_fetch_assoc($result))
{
	...
	while ($row = mysqli_fetch_assoc($result1))
	{
		...
		$result2 = mysqli_query($conn, "INSERT INTO `cirp`.`like_percentage`
		            (`id`,
		             `q_ID`,
		             `percentage`)
				VALUES (NULL,
	...
	$result3= mysqli_query($conn , "SELECT `percentage`,`q_ID` FROM like_percentage ORDER BY `percentage` LIMIT 10");
