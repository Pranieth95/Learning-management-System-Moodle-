...
select{
    	...
    	<div id="header"></div> 
 		...
 		<div id="logo"></div>
           ...
           <a href='Login1.php?logout'>LogOut</a>    
				<h2 align="left">Manage Club Events</h2>
                <p align="left">Edit or Remove planned events that are hold by clubs, using this tool</p>		
                ...
                <td><h4>Est. Budget: </h4></td>  
                <td>
                <span class="Budget">
    				<input type="number" placeholder="" min="0" max="1000000" step="1" value="" name="Budget" id="Budget" class="form-control" style="width:200px" required="required" />
 ...
 $(document).ready(function(){  
      ...
      $('#action').click(function(){  
           ...
           if(eventTitle != '' && eventDetails != '' && Budget != '')
           {  
                $.ajax({  
                     url : "action55.php",  
                     method:"POST",  
                     data:{eventTitle:eventTitle, eventDetails:eventDetails, Budget:Budget, id:id, action:action},  
                     success:function(data){  
                          alert(data);  
                          fetchUser();  
                     }  
